...
public class TopNewsAdapter extends RecyclerView.Adapter<TopNewsAdapter.ViewHolder> {
    ...
    public TopNewsAdapter(Context context, ArrayList<News> arrNews) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.line_fragment_top_news, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tv_top_news_title.setText(news.getTitle());

        holder.tv_top_news_date.setText(parseDate(news.getCreatedAt()));

        holder.tv_top_news_view.setText( formatNumber("###.###",news.getView()) + " lượt xem");
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_top_news_title, tv_top_news_date, tv_top_news_view;
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imv_thumbnail_news = itemView.findViewById(R.id.imv_thumbnail_news);
            tv_top_news_title = itemView.findViewById(R.id.tv_top_news_title);
            tv_top_news_date = itemView.findViewById(R.id.tv_top_news_date);
            tv_top_news_view = itemView.findViewById(R.id.tv_top_news_view);
